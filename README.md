...
| `INTEGER`    | `nrmt`       | `1`       | number of points on the logarithmic radial grid, at or below the MT radius, at which the partial DOS and electronic factors are evaluated and printed to the corresponding `*.dat` files |
